...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 documents/mo', 'Basic summary', 'Risk detection', 'Community support'] },
  { name: 'Pro', price: '$79/mo', features: ['500 documents/mo', 'Full analysis suite', 'Clause extraction', 'API access', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited documents', 'Custom AI models', 'Compliance reporting', 'SLA guarantee', 'Dedicated support'] },
];
